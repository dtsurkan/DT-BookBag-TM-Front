...
export const registerUserToStrapi = (data) =>
  post(STRAPI_URL, "/auth/local/register", { data });
...
export const resetPasswordAuthStrapi = (data) =>
  post(STRAPI_URL, "/auth/reset-password", { data });
